...
const char* keys =
"{help h usage ? | | Usage examples: \n\t\t./mask-rcnn.out --image=cars.jpg \n\t\t./mask-rcnn.out --video=cars.mp4}"
...
int main(int argc, char** argv)
{
	...
	if (!parser.has("image")) {
		//svideo.open(outputFile, VideoWriter::fourcc('M', 'J', 'P', 'G'), 28, Size(cap.get(CAP_PROP_FRAME_WIDTH), cap.get(CAP_PROP_FRAME_HEIGHT)));
	}
...
putText(frame, label, Point(0, 5), FONT_HERSHEY_SIMPLEX, 0.5, Scalar(0, 0, 0));
